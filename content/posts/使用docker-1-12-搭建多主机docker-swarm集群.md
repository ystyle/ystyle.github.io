...
tags: docker
categories: 系统
slug: shi-yong-docker-1-12-da-jian-duo-zhu-ji-docker-swarmji-qun
id: 34
lastmod: '2016-09-01 20:47:15'
date: 2016-07-02 07:03:32
---

## 使用docker 1.12 搭建多主机docker swarm集群 {#使用docker-1-12-搭建多主机docker-swarm集群}
### 准备 {#准备}
...
### 安装docker engine 1.12 {#安装docker-engine-1-12}
在每台机器上执行以下命令
```shell
...
### 新版docker swarm 命令详情 {#新版docker-swarm-命令详情}
有关集群的docker命令如下：
...
### 创建一个overlay 跨主机网络 {#创建一个overlay-跨主机网络}
- 查看原有网络
...
### 在新的跨主机overlay 网络(docker-net)上创建应用 {#在新的跨主机overlay-网络-docker-net-上创建应用}
...
### dokcer swarm自带的负载均衡 {#dokcer-swarm自带的负载均衡}
创建一组服务
```shell
