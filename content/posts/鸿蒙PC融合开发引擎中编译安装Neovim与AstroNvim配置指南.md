...
- Matebook Pro
categories: 软件
slug: matebookpro-container-build-neovim
---
...
## 三、编译tree-sitter CLI {#三、编译tree-sitter-CLI}
...
## 六、验证tree-sitter工作 {#六、验证tree-sitter工作}
