...
## 起因：MCP 协议的 Token 困境 {#起因：MCP-协议的-Token-困境}
...
## 核心想法：用 S-Expr 替代 JSON {#核心想法：用-S-Expr-替代-JSON}
