...
lastmod: 2020-03-15 14:46:26
tags:
- SSH
- terminal
categories: 软件
slug: add-ssh-command-to-windows-terminal-tab
---

>注意替换路径

### 用git-bash带的SSH {#用git-bash带的SSH}
...
```
### 用Power Shell自带的SSH {#用Power-Shell自带的SSH}
...
### 添加右键菜单-在任意地方打开Window Terminal {#添加右键菜单-在任意地方打开Window-Terminal}
