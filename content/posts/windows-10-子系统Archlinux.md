...
slug: Windows-10-open-with-wsl-Archlinux
tags:
  - Archlinux
  - WSL
categories:
...
### Archlinux简略安装配置过程 {#Archlinux简略安装配置过程}
...
### 以下存为文件 -> `文件夹空白位置右键打开zsh.reg` {#以下存为文件-gt-文件夹空白位置右键打开zsh-reg}
```reg
...
### 以下存为文件 -> `文件夹空白位置右键打开vim.reg` {#以下存为文件-gt-文件夹空白位置右键打开vim-reg}
```reg
Windows Registry Editor Version 5.00
...
### 以下存为文件 -> `文件右键用vim打开.reg` {#以下存为文件-gt-文件右键用vim打开-reg}
```reg
Windows Registry Editor Version 5.00
